...
/**
 * @file
 * Contains \Drupal\gaya_editorial_picture\Plugin\Field\FieldType\ImageGeItem.
 */

namespace Drupal\gaya_editorial_picture\Plugin\Field\FieldType;
 ...
 *   default_widget = "image_image_ge",
 *   default_formatter = "image_ge",
 *   column_groups = {
 *     "file" = {
 ...
 * )
 */
class ImageGeItem extends FileItem {
  ...
  public static function schema(FieldStorageDefinitionInterface $field_definition) {
    return array(
      'columns' => array(
        ...
        'url' => array(
          'description' => "Url to add in the picture.",
          'type' => 'varchar',
          'length' => 1024,
        ),
        'width' => array(
  ...
  public static function propertyDefinitions(FieldStorageDefinitionInterface $field_definition) {
    ...
    $properties['url'] = DataDefinition::create('string')
      ->setLabel(t('Title'))
      ->setDescription(t("Url to add in the picture."));
  ...
  public static function generateSampleValue(FieldDefinitionInterface $field_definition) {
    ...
    $extensions = array_intersect(explode(' ', $settings['file_extensions']), array('png', 'gif', 'jpg', 'jpeg', 'svg'));
