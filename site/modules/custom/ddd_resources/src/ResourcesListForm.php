<?php
  ...
  class ResourcesListForm extends EntityForm {
    /**
     * {@inheritdoc}
     */
    public function form(array $form, FormStateInterface $form_state) {
      $form = parent::form($form, $form_state);
      /** @var \Drupal\ddd_resources\Entity\ResourcesInterface $entity */
      $entity = $this->entity;
      $form['label'] = [
        '#type' => 'textfield',
        '#title' => t('Label'),
      ...
      $form['email'] = [
        ...
        '#description' => 'Cet email est utilisé lorsqu\'une ressources est signalé "hors ligne"',
