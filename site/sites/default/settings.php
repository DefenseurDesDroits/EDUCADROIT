 ...
 * @endcode
 */
$settings['hash_salt'] = '3YQPjjuoynvKwG_Nh1sHODM1FI4Et2H4mUY53VFW37Z4lkT5Yo2q6ziiDg6uCG3zZqkt6JMrqg';
...
# Reverse proxy en test
if (getenv('DRUPAL_CONTEXT') == 'Production/Staging' )  {
	$settings['reverse_proxy'] = TRUE;
	$settings['reverse_proxy_addresses'] = array($_SERVER['REMOTE_ADDR']);
}

if (!(getenv('DRUPAL_CONTEXT') == 'Production/Staging' || getenv('DRUPAL_CONTEXT') == 'Development')) {
	$base_url = $protocol . "://" . "educadroit.fr";
}
